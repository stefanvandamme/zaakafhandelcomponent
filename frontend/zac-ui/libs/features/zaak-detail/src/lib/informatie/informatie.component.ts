...
export class InformatieComponent implements OnInit, OnChanges {
  ...
  /** @type {boolean} Whether the property API is loading. */
  isPropertyAPILoading: boolean;
  ...
  get isLoading(): boolean {
    return this.isCaseAPILoading || this.isPropertyAPILoading
  }
  ...
  submitForm(data) {
    ...
    this.submitZaak(zaakData);  // fixme;
  }
